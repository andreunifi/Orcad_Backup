...
(library Library_1
	...
	(symbolDef "LTST-C193KSKT-5A" (originalName "LTST-C193KSKT-5A")
	...
	(compDef "LTST-C193KSKT-5A" (originalName "LTST-C193KSKT-5A") (compHeader (numPins 2) (numParts 1) (refDesPrefix LED)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "LTST-C193KSKT-5A"))
		...
		(attr "Manufacturer_Part_Number" "LTST-C193KSKT-5A")
		(attr "Mouser Part Number" "859-LTSTC193KSKT5A")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Lite-On/LTST-C193KSKT-5A?qs=xIkB7y1OTopS52H3QXHfig%3D%3D")
		(attr "Arrow Part Number" "LTST-C193KSKT-5A")
		(attr "Arrow Price/Stock" "https://www.arrow.com/en/products/ltst-c193kskt-5a/lite-on-technology?utm_currency=USD&region=nac")
		(attr "Description" "2.3 V Yellow LED 1608 (0603)  SMD, Lite-On LTST-C193KSKT-5A")
		(attr "<Hyperlink>" "http://uk.rs-online.com/web/p/products/6921054")
		(attr "<Component Height>" "0.45")
		(attr "<STEP Filename>" "LTST-C193KSKT-5A.stp")
		(attr "<STEP Offsets>" "X=0;Y=-0.06;Z=0")
